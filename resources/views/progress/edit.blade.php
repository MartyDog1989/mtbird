...
@section('content')
    ...
    {{ method_field('PUT') }}
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="inpuestDateInput" name="inpuest_date" value="{{ $progress->inpuest_date }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="radio" class="form-control" id="demandFlgCheck" name="demand_flg" value="1" {{ $progress->demand == 1 ? 'checked' : null }}>
            <label for="demandflgUnCheck">未請求</label>
            <input type="radio" class="form-control" id="demandFlgUnCheck" name="demand_flg" value="0" {{ $progress->demand == 0 ? 'checked' : null }}>
        </div>
