        ...
        <div class="form-group row">
            <div>請求</div>
                <div class="radio-inline">
                    <label>
                        <input type="radio" id="demandFlgCheck" name="demand_flg" value="1"
                            {{ old('demand_flg') ? checked : '' }}>請求済
                    </label>
                </div>
            <div class="radio-inlen">
                <label>
                    <input type="radio" id="demandFlgUnCheck" name="demand_flg" value="0"
                        {{ old('demand_flg', '0') ? checked : '' }}>未請求
                </label>
            </div>
        </div>
        <div class="form-group row">
